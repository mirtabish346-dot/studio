...
export const restaurants = [
  {
    ...
    cuisine: "Italian",
    rating: 4.5,
    image: placeholderImages.find((p) => p.id === "restaurant-1")?.imageUrl || "",
  ...
  },
  {
    ...
    cuisine: "Cafe",
    rating: 4.7,
    image: placeholderImages.find((p) => p.id === "restaurant-2")?.imageUrl || "",
    imageHint: "cozy cafe",
  },
  {
    id: "3",
    ...
    cuisine: "Mexican",
    rating: 4.3,
    image: placeholderImages.find((p) => p.id === "restaurant-3")?.imageUrl || "",
  ...
  },
  {
    ...
    cuisine: "Japanese",
    rating: 4.8,
    image: placeholderImages.find((p) => p.id === "restaurant-4")?.imageUrl || "",
    imageHint: "sushi bar",
  },
  {
    id: "5",
    ...
    cuisine: "American",
    rating: 4.2,
    image: placeholderImages.find((p) => p.id === "restaurant-5")?.imageUrl || "",
  ...
  },
  {
    ...
    cuisine: "Indian",
    rating: 4.6,
    image: placeholderImages.find((p) => p.id === "restaurant-6")?.imageUrl || "",
    ...
    items: [
      {
        ...
        price: 12.99,
        image: placeholderImages.find((p) => p.id === "menu-pizza")?.imageUrl || "",
      ...
      },
      {
        ...
        price: 15.99,
        image: placeholderImages.find((p) => p.id === "menu-pasta")?.imageUrl || "",
    ...
    items: [
      {
        ...
        price: 10.99,
        image: placeholderImages.find((p) => p.id === "menu-tacos")?.imageUrl || "",
    ...
    items: [
      {
        ...
        price: 9.99,
        image: placeholderImages.find((p) => p.id === "menu-sushi")?.imageUrl || "",
    ...
    items: [
      {
        ...
        price: 11.99,
        image: placeholderImages.find((p) => p.id === "menu-burger")?.imageUrl || "",
    ...
    items: [
      {
        ...
        price: 16.99,
        image: placeholderImages.find((p) => p.id === "menu-curry")?.imageUrl || "",
